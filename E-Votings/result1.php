		...
		<div id="me__nu">
			<div id="menu">
				<ul id="css3menu1" class="topmenu">
					<li class="topfirst"><a href="index.php" style="width:150px;height:21px;line-height:21px;"><img src="__styles/menu/house.png" alt=""/>Home</a></li>
					<li class="topmenu"><a href="result1.php" style="width:200px;height:21px;line-height:21px;" id="active"><img src="__styles/menu/door_in.png" alt=""/>Result</a></li>
					 <li class="topmenu"><a href="login.php" style="width:200px;height:21px;line-height:21px;"><img src="__styles/menu/tick.png" alt=""/>Login</a></li>
					<li class="toplast"><a href="adminLogin.php" style="width:150px;height:21px;line-height:21px;">Admin</a></li>
					</ul>
				</div>

			</div>
			<div id="bo__dy" style="padding:10px; margin-left:120px;">
