...
<ul id="css3menu1" class="topmenu">
  ...
  <li class="topmenu"><a href="update.php" style="width:130px;height:21px;line-height:21px;" id="active"><img src="__styles/menu/disk.png" alt=""/>Candidate Request</a></li>
...
<p id="demo"></p>
  ...
  <div id="bo__dy_conts">
    ...
    <form id="vote" action="test.php" method="post">

       <?php
$conn=mysqli_connect("localhost","root","","DEMO");


 $show="SELECT * from candidate where verified=0";
...
{    
    ...
    ?>
            ...
            <td  style="color:green;font-family:  Courier New; text-align: center; font-size: 18px;margin: 30px;    text-transform: uppercase;"><strong><?php echo $row[12]; ?></strong></td>
            <td  style="color:green;font-family: Courier New;  text-align: center; font-size: 18px;    text-transform: uppercase;"><strong><?php echo $row[2]; ?></strong></td>
            <td style="color:green;font-family: Courier New;  text-align: center; font-size: 18px;"> <?php echo $row[4]; ?></td> 
          

          
    <td> <button  style="cursor: pointer;"  alt="Vote" value="<?php echo $row[3];?>"  name="vote" type="submit"> View </button></td>
  ...
  echo"<center><u><h4><font color='#003300'><H3>No Request,</h3></font></h4></u></center>";
echo"<center><u><h4><font color='#003300'><H3>You have already update, No new candidate has registered yet .</h3></font></h4></u></center>";
